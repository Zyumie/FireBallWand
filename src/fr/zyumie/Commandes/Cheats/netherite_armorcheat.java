...
public class netherite_armorcheat implements CommandExecutor {
	    ...
	    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
	        ...
	        player.getInventory().addItem(createArmor(Material.NETHERITE_LEGGINGS));
	        player.getInventory().addItem(createArmor(Material.NETHERITE_BOOTS));

	        player.sendMessage("§cL'Armure en Netherite Cheat complète a été ajoutée à ton inventaire.");
	        return true;
	    }
